...
// Vercel يتطلب تصدير دالة افتراضية تقبل Request وترد Response
export default async function handler(request: Request) {
    // الحصول على المتغيرات من process.env (Vercel Environment Variables)
    ...
    // استخدام webhookCallback مع وضع 'http' (لـ Vercel)
