        ...
        <div className="h-screen flex flex-col bg-white dark:bg-gray-900 p-6">
            <div className="flex-1 flex flex-col justify-center">
                ...
                <div className="space-y-4">
                    <button onClick={() => navigate('/signup/customer')} className="w-full p-6 border-2 border-gray-200 dark:border-gray-700 rounded-2xl flex items-center gap-4 hover:border-brand-300">
                    ...
                    <button onClick={() => navigate('/signup/driver')} className="w-full p-6 border-2 border-gray-200 dark:border-gray-700 rounded-2xl flex items-center gap-4 hover:border-brand-300">
